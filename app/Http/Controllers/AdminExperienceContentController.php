    ...
    private function rulesFor(string $type): array
    {
        return match ($type) {
            'settings' => [
                ...
                'letter_subtitle' => ['nullable', 'string', 'max:255'],
                'letter_body' => ['nullable', 'string', 'max:10000'],
                'letter_signature' => ['nullable', 'string', 'max:255'],
                'letter_footer' => ['nullable', 'string', 'max:500'],
                'final_intro_title' => ['nullable', 'string', 'max:500'],
                'final_intro_subtitle' => ['nullable', 'string', 'max:255'],
                'final_continue_label' => ['nullable', 'string', 'max:120'],
                'final_reveal_lines' => ['nullable', 'string', 'max:6000'],
                'final_tap_hint' => ['nullable', 'string', 'max:255'],
                'final_question' => ['nullable', 'string', 'max:1000'],
                'final_primary_answer' => ['nullable', 'string', 'max:255'],
                'final_secondary_answer' => ['nullable', 'string', 'max:255'],
                'final_gift_title' => ['nullable', 'string', 'max:500'],
                'final_gift_message' => ['nullable', 'string', 'max:2000'],
                'final_gift_lines' => ['nullable', 'string', 'max:3000'],
            ],
            'memories' => [
